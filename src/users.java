...
public class users extends javax.swing.JFrame {
   ...
   Color DefaultColor, ClickedColor;
    public users() {
        ...
        loadUserData(); // <-- this auto-loads data on startup
    ...
    try {
            ...
            String query = "SELECT id, first_name, last_name, sex, course, year_level FROM users";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "First name", "Last name", "Sex", "Course", "Year level"
            }
        ));
